...
- Name: e2e/guru99-home.spec.ts >> Guru99 Home >> Case 4 - iFrame and tab handling
- Location: test/e2e/guru99-home.spec.ts:6:9
...
Call log:
  - navigating to "http://demo.guru99.com/test/guru99home", waiting until "load"
...
```ts
  ...
  4  | 
  5  | test.describe('Guru99 Home', () => {
  6  |     test('Case 4 - iFrame and tab handling', async ({ page, context }) => {
  7  |         const homePage = new Guru99Page(page);
  8  | 
  9  |         // Step 1: Open URL
  10 |         await test.step('Navigate to Online HTML Editor page', async () => {
> 11 |             await page.goto(ConfigManager.getGuru99Url());
     |                        ^ Error: page.goto: Test timeout of 30000ms exceeded.
  12 |         });
  13 | 
